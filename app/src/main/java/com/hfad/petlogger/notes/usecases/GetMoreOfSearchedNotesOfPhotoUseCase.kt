...
class GetMoreOfSearchedNotesOfPhotoUseCase(private val mediaRepository: MediaRepository, private val photoId: Long, private val notesAmt: Int): GetSearchedItemsUseCase<Note> {
    ...
    override suspend fun invoke(): List<Note> {
        val notes = mediaRepository.getSearchedNotesOfPhotoUseCase(photoId, currentQuery, lastNoteEditedDate, lastNoteId, notesAmt)
