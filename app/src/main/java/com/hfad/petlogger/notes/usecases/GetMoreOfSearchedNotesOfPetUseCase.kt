...
class GetMoreOfSearchedNotesOfPetUseCase(private val petRepository: PetRepository, private val petId: Long, private val notesAmt: Int): GetSearchedItemsUseCase<Note> {
    ...
    override suspend fun invoke(): List<Note> {
        val notes = petRepository.getSearchedNotesOfPetPaginated(petId, currentQuery, lastNoteEditedDate, lastNoteId, notesAmt)
