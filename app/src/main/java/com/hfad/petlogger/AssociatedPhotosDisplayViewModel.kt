...
import com.hfad.petlogger.photodisplay.GetAssociatedItemsUseCase
import com.hfad.petlogger.util.Navigator
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.flow.StateFlow
import kotlinx.coroutines.launch

class AssociatedPhotosDisplayViewModel(getAssociatedPhotos: GetAssociatedItemsUseCase<Photo>) : ViewModel() {
    ...
    companion object {
        fun provideFactory(getAssociatedPhotos: GetAssociatedItemsUseCase<Photo>): ViewModelProvider.Factory = object : ViewModelProvider.Factory {
