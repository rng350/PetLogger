...
class EditSelectionTracker<T>(override val choiceLimit: Int? = null):
    com.hfad.petlogger.common.selectiontracker.SelectionTracker<T> {
    private val tracker: com.hfad.petlogger.common.selectiontracker.EditSelectionTrackerInterface<CheckableItem<T>, T> =
        if (choiceLimit == 1) com.hfad.petlogger.common.selectiontracker.EditSelectionTrackerSinglePick<CheckableItem<T>, T>()
        else com.hfad.petlogger.common.selectiontracker.EditSelectionTrackerMultiPick<CheckableItem<T>, T>(
            choiceLimit
        )
