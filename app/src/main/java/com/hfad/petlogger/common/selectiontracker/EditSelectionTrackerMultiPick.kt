...
import com.hfad.petlogger.common.mutableCopyOf
...
class EditSelectionTrackerMultiPick<T: CheckableItem<U>, U>(choiceLimitSet: Int? = null):
    com.hfad.petlogger.common.selectiontracker.EditSelectionTrackerInterface<T, U> {
